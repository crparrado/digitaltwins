...
equation
  ...
  m*der(medium.h)+der(m)*medium.h=Q_losses+W_net+fluid_a.m_flow*inStream(fluid_a.h_outflow)+fluid_b.m_flow*medium.h+fluid_b2.m_flow*medium.h;
