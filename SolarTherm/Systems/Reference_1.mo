...
equation
	...
	connect(receiver.fluid_b, tankHot.fluid_a) annotation (Line(points={{-21.88,30.64},
		{-21.88,30},{-20,30},{-16,30},{-16,69},{17,69}}, color={0,127,255}));
...
//		{-21.88,30},{-20,30},{-16,30},{-16,69},{-14,69}}, color={0,127,255}));
	...
	connect(receiver.T, controlCold.T_mea) annotation (Line(points={{-23,22},
		{-10,22},{38,22},{38,1.2},{24.7,1.2}},  color={0,0,127}));
