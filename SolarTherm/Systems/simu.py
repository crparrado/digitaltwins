...
def run_simulations():
    ...
    for combination in combinations:
        try:
            ...
            with open('/home/cparrado/automation/results.csv', 'a', newline='') as file:
            ...
            with open('/home/cparrado/automation/failed_combinations.csv', 'a', newline='') as file:
                writer = csv.writer(file)
