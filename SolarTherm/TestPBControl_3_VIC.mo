...
equation
  ...
  connect(testPBMasterControl_3_VIC.m_flow_hot, pumpHot.m_flow) annotation(
    Line(points = {{-34, 36}, {-46, 36}, {-46, 12}, {-12, 12}, {-12, 4}, {-12, 4}}, color = {0, 0, 127}));
  connect(testPBMasterControl_3_VIC.m_flow_cold, pumpSimple.m_flow) annotation(
    Line(points = {{-34, 48}, {-52, 48}, {-52, -20}, {-12, -20}, {-12, -26}, {-12, -26}, {-12, -24}}, color = {0, 0, 127}));
  connect(pumpHot.fluid_b, testPBTransient_fix.fluid_a) annotation(
    Line(points = {{-6, -2}, {26, -2}, {26, -18}, {60, -18}}, color = {0, 127, 255}));
  connect(pumpSimple.fluid_b, testPBTransient_fix.fluid_a2) annotation(
    Line(points = {{-6, -30}, {58.5, -30}}, color = {0, 127, 255}));
  connect(testPBTransient_fix.T_amb, T_amb.y) annotation(
  ...
  connect(testPBMasterControl_3_VIC.T_mea, testPBTransient_fix.T) annotation(
    Line(points = {{-14, 42}, {14, 42}, {14, -36}, {58, -36}, {58, -37}, {57, -37}}, color = {0, 0, 127}));
  connect(testPBTransient_fix.fluid_b, cold_tank.ports[2]) annotation(
