...
parameter SI.SpecificEnergy k_loss_hot = 0.55e3 "Hot pump parasitic power coefficient";
  ...
  SolarTherm.TestPBMasterControl_3_CRI testPBMasterControl_3_CRI(Kp = 100, Td = 1e-6, Ti = 0.5e8, uMax = 680)  annotation(
    Placement(visible = true, transformation(origin = {-14, 42}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
...
equation
  ...
  connect(powerblock.T, testPBMasterControl_3_CRI.T_mea) annotation(
    Line(points = {{56, -36}, {16, -36}, {16, 42}, {-4, 42}, {-4, 42}}, color = {0, 0, 127}));
  connect(testPBMasterControl_3_CRI.m_flow_hot, pumpHot.m_flow) annotation(
    Line(points = {{-24, 36}, {-46, 36}, {-46, 12}, {-12, 12}, {-12, 4}, {-12, 4}}, color = {0, 0, 127}));
