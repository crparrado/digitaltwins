...
model NewPowerBlockControl
  ...
  SolarTherm.Models.Control.NewStartUpLogic5 logic(m_flow_max = m_flow_on, m_flow_startup = m_flow_on / 2, level_on = L_on, level_off = L_off, m_flow_standby = 0) annotation(
    Placement(transformation(extent = {{-10, -10}, {10, 10}})));
  //New variable
  Modelica.Blocks.Interfaces.RealInput L_mea_tk2;
equation
  connect(L_mea_tk2, logic.level_tk2);
