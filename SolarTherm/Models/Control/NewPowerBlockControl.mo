...
model NewPowerBlockControl
  ...
  Modelica.Blocks.Sources.RealExpression m_pump_2(y = 0) annotation(
    Placement(visible = true, transformation(origin = {51, -55}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.RealExpression m_tank_2(y = 0) annotation(
...
equation
  ...
  connect(m_pump_2.y, m_pump2)
    annotation (Line(points={{61,-55},{92,-55}}, color={0,0,127}));
  connect(m_tank_2.y, m_tank2)
    annotation (Line(points={{61,52},{92,52}}, color={0,0,127}));
