...
equation
  ...
  connect(pumpHot.fluid_b, powerblock.fluid_a2) annotation(
    Line(points = {{-6, -2}, {38, -2}, {38, -30}, {58, -30}, {58, -30}}, color = {0, 127, 255}));
  connect(pumpSimple.fluid_b, powerblock.fluid_a) annotation(
    Line(points = {{-6, -30}, {22, -30}, {22, -18}, {60, -18}, {60, -18}}, color = {0, 127, 255}));
  connect(powerblock.fluid_b, fixedBoundary.ports[1]) annotation(
    Line(points = {{56, -44}, {36, -44}, {36, -80}, {24, -80}, {24, -80}}, color = {0, 127, 255}));
protected
  annotation(
