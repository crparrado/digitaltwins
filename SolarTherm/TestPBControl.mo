...
extends Modelica.Icons.Example;
  ...
  Modelica.Blocks.Sources.Ramp m_source_hot(duration = 9000, height = 1000, offset = 0, startTime = 0)  annotation(
    Placement(visible = true, transformation(origin = {-82, 60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.Ramp ramp(duration = 5000, height = 500, offset = 0, startTime = 1800)  annotation(
