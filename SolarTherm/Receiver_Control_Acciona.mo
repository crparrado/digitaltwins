...
equation
  ...
  connect(L_mea, logic.level) annotation(
    Line(points = {{-108, -50}, {-46, -50}, {-46, 6}, {-14, 6}, {-14, 6}, {-12, 6}}, color = {0, 0, 127}));
  connect(m_flow_in, logic.m_flow_in) annotation(
    Line(points = {{-108, 50}, {-2, 50}, {-2, 18}, {-2, 18}, {-2, 16}}, color = {0, 0, 127}));
  connect(logic.m_flow, switch.u3) annotation(
    Line(points = {{10, 6}, {22, 6}, {22, -8}, {54, -8}, {54, -8}}, color = {0, 0, 127}));
  connect(logic.switch, switch.u2) annotation(
    Line(points = {{10, 12}, {30, 12}, {30, 0}, {54, 0}, {54, 0}}, color = {255, 0, 255}));
  annotation(
