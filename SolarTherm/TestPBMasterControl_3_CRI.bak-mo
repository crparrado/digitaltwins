...
model TestPBMasterControl_3_CRI
  ...
  Modelica.Blocks.Sources.RealExpression T_ref_input(y = T_ref) annotation(
    Placement(visible = true, transformation(extent = {{-96, 26}, {-76, 46}}, rotation = 0)));
equation
...
//  uMax = 680;
//  end if;
  connect(LimPID_PB.y, m_flow_hot) annotation(
    Line(points = {{13, 2}, {34, 2}, {34, 70}, {70, 70}}, color = {0, 0, 127}));
